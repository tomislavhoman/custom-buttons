...
public class ConstantExpandingButton extends View {
    ...
    public ConstantExpandingButton(Context context) {
        super(context);
        initView();
    }

    public ConstantExpandingButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public ConstantExpandingButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private static class DynamicPoint {
        ...
        private static final float INITIAL_ACCELERATION = 10F;
        private static final float SPEED = 300f;

        //Acceleration
        //private float a = INITIAL_ACCELERATION;
        ...
        public void update() {
            ...
            // We have hit the outer view border
    ...
    private static final class Animator implements Runnable {
        ...
        private final WeakReference<ConstantExpandingButton> expandingButtonWeakReference;

        private Animator(ConstantExpandingButton constantExpandingButton) {
            this.expandingButtonWeakReference = new WeakReference<>(constantExpandingButton);
        }

        @Override
        public void run() {
            ConstantExpandingButton parent = expandingButtonWeakReference.get();
            if (parent == null) {
                return;
            }
